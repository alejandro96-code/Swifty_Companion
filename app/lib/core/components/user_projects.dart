...
class _UserProjectsState extends State<UserProjects> {
  ...
  Map<String, List<Map<String, dynamic>>> _extractFinishedProjectsBySection(
    ...
    for (final entry in projectsUsers) {
      ...
      if (cursusIds == null || cursusIds.isEmpty) {
        continue;
      }

      final ids = cursusIds.whereType<int>().toSet();
      if (piscineIds.isNotEmpty && ids.intersection(piscineIds).isNotEmpty) {
    ...
    sections.removeWhere((_, list) => list.isEmpty);
    return sections;
  }
